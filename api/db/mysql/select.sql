...
WHERE CURDATE() BETWEEN fm.start_date AND fm.end_date;
...
-- Get customer details with their bookings count
...
-- Get total revenue for each movie
...
-- Get the most popular movie (by number of bookings)
